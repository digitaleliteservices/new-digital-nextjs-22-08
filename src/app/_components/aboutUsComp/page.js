...
const AboutUsComp = () => {
  ...
  return (
    <div className={`${poppins.className} text-white min-h-screen`}>
      {/* Global Gradient Background */}
      <div className="fixed inset-0 bg-gradient-to-b from-purple-900/20 via-purple-900/10 to-black -z-50" />

      {/* MAIN CONTENT SECTION */}
      <section className="relative overflow-hidden">
        {/* Animated background for entire section */}
        ...
        {/* Blob effects for entire section */}
        <div className="pointer-events-none absolute inset-0 -z-10">
          <motion.div
            className="absolute top-1/4 left-1/4 w-96 h-96 bg-purple-600/10 blur-3xl rounded-full"
            animate={{ scale: [1, 1.1, 1], opacity: [0.2, 0.3, 0.2] }}
            transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
          />
          <motion.div
            className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-orange-500/10 blur-3xl rounded-full"
          ...
          />
          <motion.div
            className="absolute top-3/4 left-1/2 w-64 h-64 bg-blue-500/10 blur-3xl rounded-full"
        ...
        <div className="relative px-6 pt-10 md:pt-12 pb-16 md:pb-24">
          {/* Heading */}
