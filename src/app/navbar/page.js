...
const Navbar = () => {
  ...
  bg-white shadow-md rounded-2xl font-sans transition-all duration-300
    ...
    >
      <div className="flex items-center justify-between px-4 py-2">
        ...
        <div className="hidden min-[1025px]:flex flex-1 justify-center space-x-12 text-[13px] text-[#1b1b4b] font-medium tracking-wide">
          {/* <Link href="/what-we-do" className="hover:text-[#4f46e5] transition-colors">
            What We Do
          </Link> */}
          <Link
            href="/about-us"
          ...
          {/* <Link href="/about-us" className="hover:text-[#4f46e5] transition-colors">
            About Us
          </Link> */}
          <Link
            href="/insights"
      ...
      {isOpen && (
        <div className="absolute top-full left-0 w-full bg-white px-6 py-6 flex flex-col space-y-6 rounded-b-2xl shadow-md min-[1025px]:hidden">
          ...
          {/* <Link href="/about-us" className="text-[#1b1b4b] font-medium hover:text-[#4f46e5]">
            About Us
          </Link> */}
          <Link
            href="/insights"
